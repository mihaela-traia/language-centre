...
import QuizKids from "./QuizKids";
import { jsQuizz } from "./Kids";
  ...
  return (
    <section className="testing">
      ...
      <div className="container rounded-5">
        {!showTest ? (
          <>
            <h2 className="col-12 josefin-sans-h2 text-center">Clasa II - V</h2>
            <Instructions />
          ...
          <div className="test-content row col col-12 d-flex justify-content-center">
            <QuizKids questions={jsQuizz.questions} />
          </div>
        )}
      </div>
