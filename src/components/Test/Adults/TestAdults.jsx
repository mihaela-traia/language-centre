...
import QuizAdults from "./QuizAdults";
import { jsQuizz } from "./Adults";
  ...
  return (
    <section className="testing">
      ...
      <div className="container rounded-5">
        {!showTest ? (
          <>
            <h2 className="col-12 row josefin-sans-h2 text-center pt-5">
              <span className="col-12 pt-5">Clasa VIII - XII</span>
              <span className="col-12">Adulți</span>
            </h2>
            <Instructions />
          ...
          <div className="test-content row col col-12 d-flex justify-content-center">
            <QuizAdults questions={jsQuizz.questions} />
          </div>
        )}
      </div>
